    ...
    >
      <div className="container-site">
        ...
        >
          ...
          <p className="font-sans text-cream-300 opacity-60 leading-relaxed mt-4 max-w-lg" style={{ fontSize: '0.95rem' }}>
            Selected ingredients, rich dark chocolate and an experience designed around connection.
          </p>
        </motion.div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-px" style={{ background: 'rgba(201,164,92,0.06)' }}>
          {INGREDIENTS.map((ing, i) => (
            ...
            >
              ...
              <div>
                <h3 className="font-serif text-base font-normal text-cream-100">{ing.name}</h3>
                {ing.origin && (
                  <p className="font-sans text-[0.6rem] tracking-widest uppercase text-gold-500 mt-0.5 opacity-80">
                    {ing.origin}
                  </p>
                )}
                <p className="font-sans text-sm text-cream-300 opacity-60 leading-relaxed mt-2">
                  {ing.description}
                </p>
              </div>
            </motion.article>
          ...
          >
            ...
            <div>
              <h3 className="font-serif text-base font-normal text-cream-100">Premium Dark Chocolate</h3>
        ...
        <motion.p
          ...
          className="font-sans text-cream-400 opacity-40 mt-8 text-center"
