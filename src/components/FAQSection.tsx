...
function FAQItem({ question, answer, isOpen, onToggle }: {
  ...
  return (
    <div style={{ borderBottom: '1px solid rgba(201,164,92,0.08)' }}>
      ...
      >
        <span className="font-serif text-base font-normal text-cream-100" style={{ fontSize: 'clamp(0.95rem, 2.5vw, 1.05rem)' }}>
          {question}
        </span>
        <span
          ...
          style={{
            ...
            background: isOpen ? 'rgba(201,164,92,0.1)' : 'transparent',
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            <p className="font-sans text-sm text-cream-300 leading-relaxed pb-5" style={{ opacity: 0.7 }}>
              {answer}
            </p>
          </motion.div>
        )}
      ...
      <div className="container-site">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-20">
          ...
          >
            ...
            <p className="font-sans text-cream-300 opacity-60 leading-relaxed mt-4" style={{ fontSize: '0.9rem' }}>
