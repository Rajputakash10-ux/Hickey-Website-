  ...
  return (
    ...
    >
      <div className="container-site">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-px" style={{ background: 'rgba(201,163,90,0.08)' }}>
          {ARTICLES.map((article, i) => (
            ...
            >
              ...
              <div className="p-7 flex flex-col gap-3 flex-1">
                ...
                <h3 className="font-serif text-xl text-cream-100 leading-snug group-hover:text-gold-400 transition-colors">
                  {article.title}
                </h3>
