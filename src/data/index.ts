...
export const MAIN_PRODUCT: Product = {
  ...
  images: [
    { src: '/assets/neimage/file_00000000823c820b94eb679898635077.png', alt: 'HICKEY — front view' },
    { src: '/assets/neimage/file_000000002914820bb4d33fa9e2d3e9ca.png', alt: 'HICKEY — detail' },
    { src: '/assets/neimage/file_000000002e64820b860bf6a5eb1ebb67.png', alt: 'HICKEY — lifestyle' },
    { src: '/assets/neimage/file_000000004118820b84c9a2baedfca2d6.png', alt: 'HICKEY — ingredients' },
    { src: '/assets/neimage/file_000000003b68821183c2f674559e55d2.png', alt: 'HICKEY — scratch card' },
    { src: '/assets/hickey-1.png', alt: 'HICKEY — pack front' },
    { src: '/assets/hickey-2.png', alt: 'HICKEY — pack back' },
    { src: '/assets/hickey-3.png', alt: 'HICKEY — chocolate' },
    { src: '/assets/hickey-6.png', alt: 'HICKEY — experience' },
  ],
