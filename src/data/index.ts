...
export const MAIN_PRODUCT: Product = {
  ...
  images: [
    { src: '/assets/hickey-1.png', alt: 'HICKEY Intimacy Dark Chocolate — front pack' },
    { src: '/assets/hickey-2.png', alt: 'HICKEY Intimacy Dark Chocolate — back pack' },
    { src: '/assets/hickey-3.png', alt: 'HICKEY dark chocolate pieces' },
    { src: '/assets/hickey-4.png', alt: 'HICKEY Secret Position Scratch Card' },
    { src: '/assets/hickey-5.png', alt: 'HICKEY product lifestyle' },
  ],
